...
Four-phase workflow:
  1. Explore    - Direct codebase exploration (Gemini CLI has no sub-agent support)
...
STEPS = {
    1: {
        "title": "Explore",
        "brief": "Direct codebase exploration",
        "actions": [
            "EXPLORE the codebase directly using file tools:",
            "  Use glob/grep to understand structure",
            "  Read key files (README, package files, config)",
            "  For large codebases: explore by module/directory boundary",
            "  For multiple repos: explore one at a time",
            "",
            "After exploration, extract:",
            ...
            "",
            "Continue to step 2 when exploration is complete.",
        ],
    },
    2: {
        "title": "Plan",
