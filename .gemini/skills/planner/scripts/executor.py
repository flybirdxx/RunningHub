...
STEPS = {
    ...
    2: {
        ...
        "actions": [
            ...
            "",
            "RECONCILE each milestone:",
            "  For each milestone, check if acceptance criteria are ALREADY satisfied:",
            "    - Read the files mentioned in milestone",
            "    - Check each acceptance criterion",
            "    - Determine: SATISFIED | NOT_SATISFIED | PARTIALLY_SATISFIED",
            "  Record results.",
            "",
            "Routing:",
    ...
    3: {
        ...
        "actions": [
            ...
            "  For each milestone in wave:",
            "    1. Read plan milestone and Code Changes diff",
            "    2. Apply changes to target files",
            "    3. Review changes against acceptance criteria",
            "",
            "WAVE EXECUTION PATTERN:",
            "  Wave 1: [1,2] -> implement sequentially -> review -> PASS",
            "  Wave 2: [3]   -> implement -> review -> PASS",
            "  Wave 3: [4]   -> implement -> review -> PASS -> Step 4",
            "",
    ...
    4: {
        ...
        "actions": [
            ...
            "    - Check for integration issues across milestones",
    ...
    6: {
        ...
        "actions": [
            ...
            "    - Create README.md if invisible knowledge exists",
            "    - Add module-level docstrings where missing",
            "",
            "Requirements:",
            "  - Use tabular index format for CLAUDE.md",
            "  - README.md only for invisible knowledge",
            "",
