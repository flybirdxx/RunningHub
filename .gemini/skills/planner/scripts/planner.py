...
PLANNING_STEPS = {
    1: {
        ...
        "actions": [
            ...
            "",
            "EXPLORE codebase directly using file tools:",
            "  Identify files to modify (exact paths)",
            "  Understand codebase patterns (naming, errors, tests)",
            "  Determine constraints and scope (IN/OUT)",
            "  Extract success criteria from requirements",
            "",
            "CONTEXT EFFICIENCY:",
            "  Read files selectively for planning context.",
            "  Full file reads happen later during diff creation.",
        ],
    },
    2: {
...
REVIEW_STEPS = {
    1: {
        ...
        "actions": [
            ...
            "  Checklist:",
            "  - Decision Log has multi-step reasoning for all choices?",
            "  - Policy defaults documented with backing?",
            "  - Plan structure follows format spec?",
            "  - All implementation milestones have Code Intent?",
            "",
    ...
    3: {
        ...
        "actions": [
            "WRITE UNIFIED DIFFS for all implementation milestones:",
            "  For each milestone with Code Intent:",
            "    1. Read target files",
            "    2. Write unified diff showing required changes",
            "    3. Edit plan file IN-PLACE to add diff to Code Changes section",
            "  ONLY modify Code Changes sections. Do not touch other plan sections.",
        ],
    },
    4: {
        "title": "QR-Code",
        ...
        "actions": [
            "REVIEW CODE DIFFS:",
            "  Checklist:",
            "  - Diffs accurately implement Code Intent?",
            "  - No temporal contamination in comments (Added, Fixed, etc)?",
            "  - Context lines are adequate anchors?",
            "",
            "Expected output: PASS or ISSUES",
        ],
    },
    ...
    6: {
        ...
        "actions": [
            ...
            "  Checklist:",
            "  - Comments are timeless present tense?",
            "  - CLAUDE.md uses tabular index format (no prose)?",
            "  - README.md exists if invisible knowledge documented?",
            "",
            "Expected output: PASS or ISSUES",
        ],
    },
    7: {
        ...
        "actions": [
            ...
            "  Checklist:",
            "  - All temporal contamination removed?",
            "  - CLAUDE.md sections comply with ~200 token limit?",
            "  - README.md contains only invisible knowledge?",
            "",
            "Expected output: PASS or ISSUES",
        ],
    },
