...
| Mode      | Intent                             | Command                                                                |
| --------- | ---------------------------------- | ---------------------------------------------------------------------- |
| planning  | "plan", "design", "architect"      | `python3 ${extensionPath}/scripts/planner.py --phase planning --step 1 --total-steps 4` |
| review    | "review plan" (after plan written) | `python3 ${extensionPath}/scripts/planner.py --phase review --step 1 --total-steps 3`   |
| execution | "execute", "implement", "run plan" | `python3 ${extensionPath}/scripts/executor.py --step 1 --total-steps 7`                 |
...
| ------------------------------------- | -------------------------- | ----------------------------------------------- |
| `${extensionPath}/resources/diff-format.md`            | Unified diff specification | Writing code changes in milestones              |
| `${extensionPath}/resources/temporal-contamination.md` | Comment hygiene heuristics | Writing comments in code snippets               |
| `${extensionPath}/resources/default-conventions.md`    | Structural conventions     | Making decisions without explicit user guidance |
| `${extensionPath}/resources/plan-format.md`            | Plan template structure    | Completing planning phase (injected by script)  |
