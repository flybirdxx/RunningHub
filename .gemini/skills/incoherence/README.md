...
Detects and resolves inconsistencies between documentation, code, specs, and implementation.

## Usage

Invoke via natural language in Gemini CLI:
- "Check for incoherence in the auth module"
- "Find inconsistencies between docs and implementation"
...
In Gemini CLI, incoherence dimensions are checked sequentially rather than in parallel. This increases analysis time but maintains full detection coverage across all selected dimensions.
