...
import com.runninghub.shared.domain.repository.QuickCreationServiceUploadFieldAlias
 ...
 *
 * @param quickCreateRepository 快捷创作仓库接口，提供灵感标签、模板列表和模板详情能力。
 ...
 */
internal class QuickCreateInspirationStateHolder(
