...
import com.runninghub.shared.domain.repository.QuickCreationUploadedMedia
 ...
 */
internal sealed interface QuickCreateGenerationRequestBuildResult {
    /**
 ...
 */
internal class QuickCreateGenerationRequestFactory {
    /**
     * 构建当前 Tab 的正式生成请求。
     *
