...
sealed interface QuickCreateInspirationPreviewUi {
     ...
     */
    data class Placeholder(val mediaType: QuickCreateInspirationPlaceholderMediaType) : QuickCreateInspirationPreviewUi
}
 ...
 */
internal fun List<QuickCreateInspirationTag>.toQuickCreateInspirationTagUiItems():
 ...
 */
internal fun QuickCreateInspirationTemplate.toQuickCreateInspirationTemplateUi(): QuickCreateInspirationTemplateUi {
