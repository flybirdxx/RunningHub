---
name: debug-pro
description: Systematic debugging methodology and language-specific debugging commands. Use when the user asks to debug, investigate errors, find bugs, or fix unexpected behavior across JavaScript, Python, Swift, CSS, or network issues.
---
