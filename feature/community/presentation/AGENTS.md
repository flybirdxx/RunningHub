# feature:community:presentation Instructions

## Responsibility

本模块承载 `community` 的 Presentation 契约和可复用状态逻辑，例如 UiState、Action、StateHolder、Interactor、Coordinator 或 ScreenModel 门面。
...
- Plaza UI 状态不得保存 DTO；排序、筛选和分页旧响应必须隔离。
