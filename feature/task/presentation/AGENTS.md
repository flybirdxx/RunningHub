# feature:task:presentation Instructions

## Responsibility

本模块承载 `task` 的 Presentation 契约和可复用状态逻辑，例如 UiState、Action、StateHolder、Interactor、Coordinator 或 ScreenModel 门面。
