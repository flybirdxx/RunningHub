# feature:audio:domain Instructions

## Responsibility

本模块只定义 `audio` 的领域模型、Repository interface、UseCase、业务错误和业务规则。
...
- 从 shared 迁出的音频契约应先收窄边界，避免复制旧万能 Repository。
...
./gradlew :feature:audio:domain:allTests
```
