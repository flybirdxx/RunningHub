# feature:discovery:data Instructions

## Responsibility

本模块实现 `feature:discovery:domain` 中的仓库接口，并负责远端 API、DTO、Mapper、Data DI 和数据层错误映射。
...
- Data 层集中把 CatalogQuery 映射为远端参数，Presentation 不维护协议字符串。
