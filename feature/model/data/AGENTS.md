# feature:model:data Instructions

## Responsibility

本模块实现 `feature:model:domain` 中的仓库接口，并负责远端 API、DTO、Mapper、Data DI 和数据层错误映射。
...
- Model endpoint registry 属于 Data 层，不得向 Domain/Presentation 泄漏 endpoint。
