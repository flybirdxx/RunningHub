...
6. 真实校验项目管理接口：`project/list`、`project/tasks`、`project/pin`、`project/create/rename/delete/detail` 已进入 ScreenModel/历史区 UI；下一步用非空项目抓包校正项目任务结构和项目管理请求体字段。
