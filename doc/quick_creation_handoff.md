...
6. App 内复测项目管理流程：`project/list`、`project/tasks`、`project/pin`、`project/create/rename/delete/detail` 已通过 Chrome DevTools 登录态临时项目验证并进入 ScreenModel/历史区 UI；下一步在 App 内验证项目创建、筛选、置顶、重命名、详情和删除完整流程。
